...
However, our observed data rates were much higher than initially expected (see \Cref{fig:graph-5-iodine-constant-throughput}), indicating that this limitation may no longer apply.
...
\todo[inline]{Verify this claim more thoroughly!}
