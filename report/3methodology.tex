...
\todo[inline]{explain why we're not testing corrupt packets (difficult to correlate packets)}
We measure latency by correlating ... \todo[inline]{continue}
...
\todo[inline]{Define pre and post to mean before and after the router}
